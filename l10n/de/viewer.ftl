...
pdfjs-editor-stamp-button_OK =
    .title = Häkchen hinzufügen oder bearbeiten
pdfjs-editor-stamp-button-label_OK = Häkchen
pdfjs-editor-stamp-button_CROSS =
    .title = Kreuz hinzufügen oder bearbeiten
pdfjs-editor-stamp-button-label_CROSS = Kreuz
pdfjs-editor-stamp-button_QUESTION =
    .title = Fragezeichen hinzufügen oder bearbeiten
pdfjs-editor-stamp-button-label_QUESTION = Fragezeichen
