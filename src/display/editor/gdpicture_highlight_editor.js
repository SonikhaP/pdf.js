 ...
 */
class GdPictureHighlightEditor extends AnnotationEditor {
  #anchorNode = null;
  ...
  static _editorType = AnnotationEditorType.GDPICTURE_HIGHLIGHT;
  ...
  static get _keyboardManager() {
    const proto = GdPictureHighlightEditor.prototype;
    return shadow(
      this,
      "_keyboardManager",
      new KeyboardManager([
  ...
  #createFreeOutlines({ highlightOutlines, highlightId, clipPathId }) {
    ...
    if (highlightId >= 0) {
      ...
      this.parent.drawLayer.updateProperties(this.#id, {
        bbox: GdPictureHighlightEditor.#rotateBbox(
      ...
      this.parent.drawLayer.updateProperties(this.#outlineId, {
        bbox: GdPictureHighlightEditor.#rotateBbox(this.#focusOutlines.box, angle),
        path: {
          d: this.#focusOutlines.toSVGPath(),
        },
      });
  ...
  static updateDefaultParams(type, value) {
    switch (type) {
      case AnnotationEditorParamsType.HIGHLIGHT_DEFAULT_COLOR:
        GdPictureHighlightEditor._defaultColor = value;
        break;
      case AnnotationEditorParamsType.HIGHLIGHT_THICKNESS:
        GdPictureHighlightEditor._defaultThickness = value;
        break;
    }
  }
  ...
  static get defaultPropertiesToUpdate() {
    return [
      ...
      [
        ...
        GdPictureHighlightEditor._defaultThickness,
      ],
    ];
  }
  ...
  get propertiesToUpdate() {
    return [
      [
        ...
        this.color || GdPictureHighlightEditor._defaultColor,
      ],
      [
        AnnotationEditorParamsType.HIGHLIGHT_THICKNESS,
        this.#thickness || GdPictureHighlightEditor._defaultThickness,
      ],
  ...
  #updateColor(color) {
    ...
    this.addCommands({
      cmd: setColorAndOpacity.bind(
        this,
        color,
        GdPictureHighlightEditor._defaultOpacity
      ),
  ...
  rotate(angle) {
    ...
    if (this.#isFreeHighlight) {
      ...
      box = GdPictureHighlightEditor.#rotateBbox(this.#highlightOutlines.box, angle);
    } else {
      // An highlight annotation is always drawn horizontally.
      box = GdPictureHighlightEditor.#rotateBbox(
  ...
  #keydown(event) {
    GdPictureHighlightEditor._keyboardManager.exec(this, event);
  }
